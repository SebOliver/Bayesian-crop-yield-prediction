...
Establishing the climate risk to the global production of individual crops, and how that might change in the future, is an essential requirement for building a resilient and robust food system that ensures food security for all \citep[][]{fao:2002}. %However, quantifying this risk represents a significant challenge, primarily because limited data records hinder our ability to identify causal 
